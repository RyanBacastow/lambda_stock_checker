...
Feel free to use the makefile to deploy based on your aws profile configs/credentials. Simply make sure to set an env var on your machine for $AWS_STOCK_CHECKER_LAMBDA_NAME. Otherwise you can simply upload the latest custom_stock_watcher.zip file through the cli or console.
